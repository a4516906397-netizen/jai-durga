...
• Masonry: For walls that require frequent washing, PYD PRIME SHINE provides a durable, washable finish (after proper surface preparation).`,
  ...
  },
  {
    ...
    name: 'PYD Tile Adhesive 131',
    slug: 'tile-adhesive-silver',
    category: 'Adhesive',
    subTitle: 'Premium Bond for All Regular Tiles',
    description: 'A high-performance cement-based adhesive designed for fixing ceramic and mosaic tiles on floors and walls in internal applications. It provides excellent bonding strength and easy workability.',
    features: [
      'High Bonding Strength',
      'No Shrinkage Cracks',
      'Better Coverage',
      'Easy to Use and Ready to Mix',
      'Water Resistant'
    ],
    packing: '20 KG',
    image: '/product/Tileadhesivebag131.png'
  },
  {
    id: 'tile-adhesive-gold',
    name: 'PYD Tile Adhesive 231',
    slug: 'tile-adhesive-gold',
    category: 'Adhesive',
    subTitle: 'Advanced Superior Bond for Large Format Tiles',
    description: 'An advanced high polymer modified waterproof tile adhesive for fixing large format vitrified tiles, natural stones, and marble on floor and wall areas in internal and external conditions.',
    features: [
      'Extraordinary Bonding Strength',
      'Thermal Shock Resistance',
      'Long Open Time',
      'Anti-Slump Properties',
