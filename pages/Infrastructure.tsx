   ...
   return (
      <div className="pt-24 min-h-screen bg-white pb-20 font-sans">
         ...
         <div className="relative h-64 md:h-96 lg:h-[400px] overflow-hidden">
            <img src="/images/factory.png" alt="Factory" className="w-full h-full object-cover grayscale" />
         ...
         <div className="bg-slate-50 py-24 border-t border-slate-200">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
               ...
               <div className="grid grid-cols-2 gap-4">
                  <img src="/images/test.png" alt="Lab" className="w-full h-64 object-cover rounded-sm shadow-md translate-y-8" />
                  <img src="/images/colour.png" alt="Storage" className="w-full h-64 object-cover rounded-sm shadow-md" />
                  <img src="/images/production.png" alt="Machinery" className="w-full h-64 object-cover rounded-sm shadow-md translate-y-8" />
                  <img src="/images/stainer.png" alt="Team" className="w-full h-64 object-cover rounded-sm shadow-md" />
               </div>
            </div>
         </div>
